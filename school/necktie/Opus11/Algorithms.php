...
require_once 'StackAsLinkedList.php';
require_once 'QueueAsLinkedList.php';
require_once 'ChainedHashTable.php';
require_once 'PartitionAsForest.php';
require_once 'AVLTree.php';
require_once 'IDigraph.php';
require_once 'BinaryHeap.php';
require_once 'PartitionAsForest.php';
require_once 'GraphAsMatrix.php';
require_once 'GraphAsLists.php';
require_once 'DigraphAsMatrix.php';
require_once 'DigraphAsLists.php';
