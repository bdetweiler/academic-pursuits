...
echo "total nodes in matrix: $totalNodesInMatrix\n";
...
// Memory is at a premium here. We need all we can get.
unset($triangleNum);
unset($triangleNumArr);
unset($runningTotal);
unset($currentLine);
