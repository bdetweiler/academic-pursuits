...
/**
 */
require_once '../StraightInsertionSorter.php';
require_once '../BinaryInsertionSorter.php';
require_once '../BubbleSorter.php';
require_once '../StraightSelectionSorter.php';
require_once '../HeapSorter.php';
require_once '../MedianOfThreeQuickSorter.php';
require_once '../TwoWayMergeSorter.php';
require_once '../BucketSorter.php';
require_once '../RadixSorter.php';
