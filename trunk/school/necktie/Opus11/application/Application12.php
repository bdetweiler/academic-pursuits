...
require_once '../DepthFirstSolver.php';
require_once '../DepthFirstBranchAndBoundSolver.php';
require_once '../BreadthFirstSolver.php';
require_once '../BreadthFirstBranchAndBoundSolver.php';
require_once '../ScalesBalancingProblem.php';
require_once '../ZeroOneKnapsackProblem.php';
